...
function Home() {
	return (
		<div className="subpixel-antialiased">
			...
			<div className="flex">
				<p className="m-auto px-4 py-4 text-center text-3xl mt-6 underline underline-offset-8 rounded-lg" style={{ fontFamily: 'Fivo', fontWeight: 'bold' }}>What they say:</p>
			</div>
			<div className="flex">
				<div className="self-start max-w-md mx-12 pb-4 border-2 border-stone-900 relative mt-8" style={{ boxShadow: '4px 10px' }}>
